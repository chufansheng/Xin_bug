...
@interface YuLeTableViewController ()<SDCycleScrollViewDelegate>
...
- (void)viewDidLoad {
    ...
    //轮播图网络加载
//    [[TouTiaoHelper new]requestWithTouTiaoHeaderImgFinsh:^(NSMutableArray *array) {
...
//    }];
    ...
    [[TouTiaoHelper new]requestWithHeaderImgUrl:kYuLeUrl(_pageSize) Finsh:^(NSMutableArray *array) {
    ...
    [[TouTiaoHelper new]requestWithListCellofUrl:kYuLeUrl(_pageSize) Finsh:^(NSMutableArray *array) {
